...
const products = [
  {
    ...
    imageUrl: 'https://img1.wsimg.com/isteam/ip/4000732a-f94c-4a6b-af0e-3bed8608d9b9/21112216375724704443.jpg',
  ...
  },
  {
    ...
    price: 19.00,
    originalPrice: 23.00,
    imageUrl: 'https://img1.wsimg.com/isteam/ip/4000732a-f94c-4a6b-af0e-3bed8608d9b9/ols/fa304e6b-1630-443e-8872-79b5ac49e332_1.48f8ee.jpeg',
  ...
  },
  {
    ...
    imageUrl: 'https://img1.wsimg.com/isteam/ip/4000732a-f94c-4a6b-af0e-3bed8608d9b9/21111116366862718152.jpg',
  ...
  },
  {
    ...
    imageUrl: 'https://img1.wsimg.com/isteam/ip/4000732a-f94c-4a6b-af0e-3bed8608d9b9/ols/19090615678293919230.jpg',
  ...
  },
  {
    ...
    imageUrl: 'https://img1.wsimg.com/isteam/ip/4000732a-f94c-4a6b-af0e-3bed8608d9b9/ols/FLX8.31-P_1111.jpg',
  ...
  },
  {
    ...
    imageUrl: 'https://img1.wsimg.com/isteam/ip/4000732a-f94c-4a6b-af0e-3bed8608d9b9/ols/MagBench-mini-jig-tool-2_1.jpg',
  ...
  },
  {
    ...
    imageUrl: 'https://img1.wsimg.com/isteam/ip/4000732a-f94c-4a6b-af0e-3bed8608d9b9/ols/DNR1.1-1_3.jpg',
  ...
  },
  {
    ...
    imageUrl: 'https://img1.wsimg.com/isteam/ip/4000732a-f94c-4a6b-af0e-3bed8608d9b9/ols/21081816292791738891.jpg',
  ...
  },
  {
    ...
    imageUrl: 'https://img1.wsimg.com/isteam/ip/4000732a-f94c-4a6b-af0e-3bed8608d9b9/ols/20092916013684898094.jpg',
  ...
  },
  {
    ...
    price: 24.99,
    originalPrice: 26.00,
    imageUrl: 'https://img1.wsimg.com/isteam/ip/4000732a-f94c-4a6b-af0e-3bed8608d9b9/ols/21012116112179383660.jpg/:/rs=w:500,h:500',
...
export function NewProductsSection() {
    ...
    const handleAddToCart = (productId: number, e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    return (
        <section className="w-[88%] mx-auto py-8 md:py-12">
                        ...
                        <Link href={`/products/${product.slug}`} className="block">
                            <div className="aspect-square relative">
                                ...
                                <Button
                                    ...
                                    onClick={(e: React.MouseEvent<HTMLButtonElement>) => handleAddToCart(product.id, e)}
                            ...
                            <CardContent className="p-3">
                                ...
                                <div className="mt-2 flex flex-col items-end gap-1 sm:flex-row sm:items-baseline sm:justify-end sm:gap-2">
                                    ...
                                    {product.originalPrice && (
                                        <span className="text-sm text-gray-500 line-through"> {/* Stays same size */}
                                            ${product.originalPrice.toFixed(2)}
                                        </span>
                                    )}
                                    <span className="font-bold text-lg text-red-700"> {/* Stays same size */}
            ...
            <div className="mt-8 flex justify-center">
                <Button asChild className="bg-red-700 hover:bg-red-600 px-6 py-3 text-base">
