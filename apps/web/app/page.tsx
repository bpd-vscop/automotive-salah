...
export default function Home() {
    ...
    return (
        ...
        <div className="flex min-h-screen flex-col bg-gray-50"> {/* Added a light background */}
            ...
            <main className="flex-1"> {/* flex-1 allows main to grow and push footer down */}
                ...
                <section className="w-[88%] mx-auto py-8 md:py-12">
                    ...
                    <h2 className="mb-6 text-2xl font-bold tracking-tight text-gray-800">Shop by Category</h2>
                ...
                <section className="w-[88%] mx-auto py-8 md:py-12">
                    ...
                    <h2 className="mb-6 text-2xl font-bold tracking-tight text-gray-800">Featured Manufacturers</h2>
